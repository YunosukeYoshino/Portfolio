      ...
      <section className="mb-[var(--sectiongap)]">
        <div>
          <header className="mb-12">
            <h1 className="label-mono mb-5">Privacy Policy</h1>
          ...
          <div className="prose max-w-none">
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">収集する情報</h2>
              <p className="mb-4">
            ...
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">情報の利用目的</h2>
              <p className="mb-4">収集した限定的な情報は、以下の目的でのみ使用します：</p>
              <ul className="list-disc space-y-1 pl-5">
            ...
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">Google Analyticsの使用</h2>
              <p className="mb-4">
            ...
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">第三者との情報共有</h2>
              <p className="mb-4">
            ...
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">Cookieについて</h2>
              <p className="mb-4">
            ...
            <section className="mb-10">
              <h2 className="mb-4 text-lg font-semibold">お問い合わせ</h2>
              <p className="mb-4">
